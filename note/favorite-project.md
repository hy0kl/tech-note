...
## 依赖组件
https://github.com/ltnetcase/libgd
https://github.com/trondn/libmemcached
https://github.com/shift/libxml2
...
### crawler
https://github.com/Yehuda-Daniel/PHP-Crawler
### php 操作视频的扩展
...
### Swoole
是一个PHP的C扩展，可用来开发PHP的高性能高并发TCP/UDP Server。Swoole的网络IO部分基于epoll/kqueue事件循环，是全异步非阻塞的。 业务逻辑部分使用多进程同步阻塞方式来运行。这样既保证了Server能够应对高并发和大量TCP连接。又保证业务代码仍然可以简单的编写。
https://github.com/matyhtf/swoole # PHP's asynchronous & concurrent & distributed networking framework.
...
### facebook 出品的 php 性能分析工具
https://github.com/facebook/xhprof

## editor是由百度web前端研发部开发的所见即所得富文本web编辑器，开源基于BSD协议
https://github.com/windsdeng/ueditor-for-yii

## 系统或框架
### SVN hooks in PHP
https://github.com/jeanmonod/php-svn-hook
### phpDocumentor
https://github.com/phpDocumentor/phpDocumentor2
### 全新的php 写的数据库管理工具 Database management in a single PHP file
https://github.com/vrana/adminer
### 基于 php + mysql 的问答系统
http://www.question2answer.org/
### 简洁的 wordpress 皮肤
https://github.com/dangoakachan/dangopress
### php 开源日志库
https://github.com/Seldaek/monolog
### Just a Simple HTML DOM
...
https://github.com/nnmatveev/php-stubs
### 基于ThinkPHP的各大开放平台 Open API SDK 扩展
https://github.com/Aoiujz/ThinkSDK
### 开源 bugs 系统
...
https://github.com/PHPOffice/PHPVisio
https://github.com/PHPOffice/PHPProject
...
# lua
## lua mysql
https://github.com/alacner/lua-mysql
https://github.com/keplerproject/luasql
## Fast JSON parsing and encoding support for Lua
https://github.com/mpx/lua-cjson/
## lua curl c 扩展, easy, multi, share
https://github.com/msva/lua-curl
## lua iconv c 扩展
...
# Easily type math in your webapp 数学公式编辑器
https://github.com/mathquill/mathquill
# cloud storage system
https://github.com/haiwen/seafile
# Walmart Labs
https://github.com/walmartlabs http://walmartlabs.com/
# shell 版俄罗斯方块
...
# Mailbox 在 tableViewCell 上的手势开源实现
https://github.com/alikaragoz/MCSwipeTableViewCell
# 使用 Makefile 编译,打包,生成 OTA 安装文件,短链接,二维码,邮件通知
https://gist.github.com/lexrus/5706727
# java 中文分词
https://github.com/ansjsun/ansj_seg
# c 物理引擎
https://github.com/slembcke/Chipmunk2D
# quick-cocos2d-x,貌似停更?
https://github.com/chukong/quick-cocos2d-x
# cocos2d 高仿微信打飞机
https://github.com/hxy060799/PlaneWar
...
# chrome 插件
https://github.com/CoryG89/MDNJump
https://github.com/anhero/JsonBox
https://github.com/rakshasa/libtorrent
https://github.com/ucweb/ucmq
# 开源 iOS app
https://github.com/imtiger/HappyEnglish
https://github.com/mongodb/mongo
# c web crawler
https://github.com/jourlin/WebCrawler
# 开源iOS 图表库
...
# c++
https://github.com/qteqpid/spiderq
...
# 缓存代理, redis, memcache, 纯 c 实现
https://github.com/twitter/twemproxy
# 函数响应式编程框架
https://github.com/ReactiveCocoa/ReactiveCocoa
# 翻译的游戏开发相关文章.
https://github.com/cocos2d/cocos-docs
# oc 的 html dom 解析库,封装自 google 的 gumbo-parser
https://github.com/tracy-e/OCGumbo
# google 的 html dom 解析库
...
https://github.com/git/git # git 源码
# zeromq 消息队列
https://github.com/zeromq
## 消息队列库
https://github.com/zeromq/libzmq
# C语言开源高性能中文分词组件，C语言mmseg中文分词器 High performance chinese tokenizer with both GBK and UTF-8 charset support developed by ANSI C
https://github.com/lionsoul2014/friso
# go 语言的 mysql proxy
https://github.com/youtube/vitess
# 百度 dbproxy 的部分源代码, java 版
...
# twitter 开源的 scala 消息队列 simple, distributed message queue system
https://github.com/twitter/kestrel
# 开源的LDAP(LightweightDirectoryAccessProtocol)实现
...
# GoAccess is an open source real-time web log analyzer and interactive viewer that runs in a terminal in *nix systems. 可作 nginx 日志分析
https://github.com/allinurl/goaccess

# sql 注入工具
## python
https://github.com/sqlmapproject/sqlmap
## Hexjector是一个开放源代码、跨平台的 PHP 脚本程序，它可以自动扫描网站的 SQL 注入漏洞
...
https://github.com/ryanzhw1987/easynetwork
...
# cspider
https://github.com/xonce/CSpider
...
# 二进制比较工具
http://www.zynamics.com/index.html
